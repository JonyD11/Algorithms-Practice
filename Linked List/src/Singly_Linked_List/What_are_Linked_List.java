...
public class What_are_Linked_List {
	 ...
	 * linked using pointers as shown below:
	 * 
	 *  Head
	 * ___|________    ________    ________    ________
	 * |__A__|____| -> |_B_|__| -> |_C_|__| -> |_D_|__| -> Null
	 *  Data  Next
	 *  
	 ...
	 * 1) The size of the array is fixed: So we must know the upper limit on the
	 ...
	 *    list.
	 * 3) Not cache friendly. Since array elements are contiguous location there is
	 ...
	 * LinkedList can be represented as a class and a Node as separate class. The
